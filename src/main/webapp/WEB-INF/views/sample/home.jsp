	...
	<div id="wrap">
		...
		<section class="content">
			...
			<section class="promotion-section">
				<div class="container">
					<ul class="promo-list">
						<li><href ="#" onclick="return false"> <img
								src="/resources/images/hak.jpg" alt="">
							<h3>HOME</h3>
				...
				<ul class="work-list">
					<li><a href="#" onclick="return false">
							<div class="info">
								<h3>작업1</h3>
								<span>소스/작업1</span>
							</div> <img src="resources/images/hak.jpg" alt="">
					</a></li>
					<li><a href="#" onclick="return false">
							<div class="info">
								<h3>작업1</h3>
			...
			<section class="blog-section">
				<div class="container">
					...
					<ul class="blog-list">
						<li><href ="#" onclick="return false">
							<img src="/resources/images/hak.jpg" alt="">
							</a> <time datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
