	...
	<section id="contents" class="row">
		<article id="main">
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/hak.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/hak.jpg" alt=""
				...
				<li class="col-6 last"><img src="/resources/images/hak.jpg"
