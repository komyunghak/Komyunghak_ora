                  ...
                  <fieldset>
                     ...
                     <ul class="reg_list">
                        <li class="clear">
                           ...
                           <input required value="${memberVO.user_id}" name="user_id" type="text" class="w100p" id="user_id" placeholder="아이디을 입력해주세요"/></div>
                        ...
                        <li class="clear">
                           ...
                           <div class="reg_content" style="padding-top:8px;">
                           <div class="app_content">
                           <input value="" name="user_pw" type="password" class="w100p" placeholder="암호를 입력해주세요"/></div>
                           </div>
                        </li>
                        <li class="clear">
                           ...
                           <div class="reg_content" style="padding-top:8px;">
                           <div class="app_content">
                           <input required value="${memberVO.user_name}" name="user_name" type="text" class="w100p" placeholder="이름을 입력해주세요"/></div>
                           </div>
                        </li>
                        <li class="clear">
                           ...
                           <div class="reg_content" style="padding-top:8px;">
                           <div class="app_content">
                           <input value="${memberVO.email}" name="email" type="text" class="w100p" placeholder="이메일을 입력해주세요"/></div>
                           </div>
                        </li>
                           
                           <input value="0" name="point" type="hidden" class="w100p" placeholder="포인트를 입력해주세요"/></div>                                       
                           <input value="1" name="enabled" type="hidden" class="w100p" placeholder="포인트를 입력해주세요"/></div>                        
                           <input value="ROLE_USER" name="levels" type="hidden" class="w100p" placeholder="포인트를 입력해주세요"/></div>                        
                     </ul>
                     <p class="btn_line">
...
$(document).ready(function(){
   $("#user_id").blur(function(){
      ...
      $.ajax({
         ...
         success:function(result){//중복아이디가 존재할때
            if(result=='1'){
